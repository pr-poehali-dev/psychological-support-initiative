...
const TESTIMONIALS = [
  { initial: "М", name: "Марина", meta: "44 года, Владивосток", text: "Пришла, когда просто перестала справляться. Работа, семья, всё навалилось — и я как будто замерла. Оказалось совсем не так, как я ожидала. Ольга сразу дала ощущение, что меня слышат — без лишних слов и без осуждения. Уже через месяц я заметила, что перестала просыпаться в 4 утра с тревогой. Это дорогого стоит." },
  { initial: "Д", name: "Дмитрий", meta: "38 лет, онлайн", text: "Я долго откладывал — думал, само пройдёт. Не прошло. На работе всё было нормально, но внутри — полный ноль, ничего не радовало. Обратился к Ольге онлайн, даже не ожидал, что формат так хорошо зайдёт. Она помогла разобраться, где у меня вообще что-то сломалось. Жизнь правда стала проще. Рекомендую без оговорок." },
  { initial: "С", name: "Светлана", meta: "51 год, Хабаровск", text: "Обратилась после развода — казалось, что это конец всего. Ольга помогла посмотреть на ситуацию с другой стороны. Не навязывала своего мнения. Вместо этого — конкретные инструменты: что делать, когда накрывает, как не уходить в голову с головой. Очень ценю, что записалась именно тогда, когда было совсем плохо." },
  { initial: "А", name: "Андрей", meta: "47 лет, Владивосток", text: "Мужчины к психологам не ходят — я так думал лет до сорока пяти. Потом случился серьёзный кризис на работе, и я понял: сам не вытяну. Первые минут десять было неловко, потом как отпустило. Ольга умеет задавать правильные вопросы — точные, без лишнего. Жалею только, что не пришёл раньше." },
  { initial: "Е", name: "Екатерина", meta: "33 года, онлайн", text: "Работаем уже три месяца. Пришла с тревогой и ощущением, что живу чужую жизнь — угождаю всем вокруг, а себя где-то потеряла. Ольга не просто слушает — она помогает структурировать то, что в голове каша. Я начала говорить «нет» на работе. Для меня это был настоящий прорыв. Советую всем, кто думает: «может, само рассосётся». Не рассосётся." },
];
